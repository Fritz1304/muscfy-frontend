            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="gb-gray-900/80 backdrop-blug-lg rounded-2xl p-8 shadow-2xl border border-gray-700 text-white">
                    <form className="space-y-6">
                        ...
                        {/* Submit button  */}
                        <button className="w-full flex justify-center py-3 px-4 broder border-transparent rounded-lg shdows-sn text-sm font-medium text-black bg-green-500 hover:gb-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disable:opacity-50 disable:cursos-not-allowed transiton-all duration-200 transform hover:scale-105">Login</button>
                    </form>
                      {/* Switch to register */}
